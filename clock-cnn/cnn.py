...
training_set = train_datagen.flow_from_directory('dataset', target_size = (150, 150), batch_size = 32, class_mode = 'binary')
test_set = test_datagen.flow_from_directory('testset', target_size = (150, 150), batch_size = 32, class_mode = 'binary')

#fit the data to our model!
#steps per epoch contains the number of training images
#epoch - a training cycle
classifier.fit_generator(training_set, steps_per_epoch = 95, epochs = 16, validation_data = test_set, validation_steps = 10)
